    ...
    public class MyAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MasterCustomerType>().HasData(
                new MasterCustomerType { CustomerTypeId = 1, CustomerType = "Individual" },
                new MasterCustomerType { CustomerTypeId = 2, CustomerType = "Company" },
                new MasterCustomerType { CustomerTypeId = 3, CustomerType = "Minnor" },
                new MasterCustomerType { CustomerTypeId = 4, CustomerType = "Joint" },
                new MasterCustomerType { CustomerTypeId = 5, CustomerType = "Nil" }
            );    

            modelBuilder.Entity<MasterRoles>().HasData(
                new MasterRoles { RoleId = 1, RoleName = "Customer" },
                new MasterRoles { RoleId = 2, RoleName = "Staff" },
                new MasterRoles { RoleId = 3, RoleName = "Manager" }
            );  

            modelBuilder.Entity<MasterAccountTypeModel>().HasData(
                new MasterAccountTypeModel { AccountTypeID = 1, AccountType = "Savings" },
                new MasterAccountTypeModel { AccountTypeID = 2, AccountType = "Current" },
                new MasterAccountTypeModel { AccountTypeID = 3, AccountType = "Salary" }
            );
